      ...
      <table class="table table-sm">
        ...
        <tr v-for="file in filteredFiles" :key="file.ID">
          ...
          <td class="text-right align-middle">
            <a href="#" @click="run(file.ID)" class="btn btn-success btn-lg">
            ...
            <a href="#" @click="lock(file.ID)" class="btn btn-primary btn-lg" v-if="file.type !== 'locked'">
            ...
            <a href="#" @click="remove(file.ID)" class="btn btn-danger btn-lg" v-if="file.type !== 'locked'">
